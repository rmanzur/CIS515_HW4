...
\def\inLim#1{\displaystyle \indlim_{#1}}
\def\projLim#1{\displaystyle \projlim_{#1}}
%\def\mod{\hbox{mod}}
\def\sgnam{\hbox{sg}}
\def\volum{\hbox{vol}}
...
\def\libvecb#1#2{#2 - #1}
\def\libvecbo#1#2{\overrightarrow{#1#2}}
%\def\libvecbo#1#2{{\boldsymbol{#1#2}}}
%\def\libvecbo#1#2{{\mathbf{#1#2}}}
%\def\vectorr#1{\overrightarrow{#1}}
\def\vectorr#1{#1}
\def\bvect#1{\mathbf{#1}}
\def\novect#1{#1}
...
\def\Homspac#1#2{\mathrm{Hom}(#1,#2)}
\def\Homspacb#1#2#3{\mathrm{Hom}_{#3}(#1,#2)}
\def\linspac#1#2{\s{L}(#1; #2)}
\def\slinspac#1#2{\s{S}(#1; #2)}
...
\def\specrow#1#2#3{(\matel{#1}{#2}{1}\, \cdots\, \matel{#1}{#2}{#3})}
\def\specrowb#1#2#3{[\matel{#1}{#2}{1}\, \cdots\, \matel{#1}{#2}{#3}]}
\def\speccol#1#2#3{\pmatrix{\matel{#1}{1}{#2}\cr \vdots\cr 
\matel{#1}{#3}{#2}\cr}}
%
\def\amsspeccol#1#2#3{%
\begin{pmatrix}
\matel{#1}{1}{#2}\\
\vdots\\
\matel{#1}{#3}{#2}
...
\def\derivp#1{#1'}
\def\derivD#1#2{\mathrm{D}^{#2}#1}
\def\derivDof#1#2{\mathrm{D}#1#2}
\def\vfderiv#1#2{\mathrm{D}_{#1}#2}
...
\def\Dparder#1#2{\mathrm{D}_{#2}{#1}}
\def\deriv#1#2{{\displaystyle{d#1\strut\over\strut d#2}}}
\def\amsderiv#1#2{\frac{d#1}{d#2}}
\def\dotderiv#1{{\dot #1}}
\def\dotdderiv#1{{\ddot #1}}
\def\vderiv#1#2{\mathrm{D}_{\vectorsmal{#1}}{#2}}
%
\def\vderivb#1#2#3{\mathrm{D}^{2}_{\vectorsmal{#1},\vectorsmal{#2}}{#3}}
\def\vderivc#1#2#3{\mathrm{D}_{\vectorsmal{#1}}{\rm D}_{\vectorsmal{#2}}{#3}}
\def\vderivd#1#2#3{\mathrm{D}_{\vectorsmal{#1}}\ldots
{\rm D}_{\vectorsmal{#2}}{#3}}
%
\def\vderivdd#1#2#3#4#5{\underbrace{\mathrm{D}_{\vectorsmal{#1}}\ldots
{\rm D}_{\vectorsmal{#2}}}_{i}\underbrace{\mathrm{D}_{\vectorsmal{#3}}\ldots
{\rm D}_{\vectorsmal{#4}}}_{j}\,{#5}}
%
\def\matdef#1#2{\mathrm{M}_{#1}#2}
\def\matdefin#1#2#3{\mathrm{M}_{#1, #2}#3}
%
\def\jacob#1#2#3#4#5{%
...
%
\def\amshessien#1#2#3#4{%
\begin{pmatrix}
\amsparderivb{#1}{#2_{1}}(#3)&\amsparderivc{#1}{#2_{1}}{#2_{2}}(#3)&\ldots&
\amsparderivc{#1}{#2_{1}}{#2_{#4}}(#3)\\[10pt]
\amsparderivc{#1}{#2_{1}}{#2_{2}}(#3)&\amsparderivb{#1}{#2_{2}}(#3)&\ldots&
\amsparderivc{#1}{#2_{2}}{#2_{#4}}(#3)\\[8pt]
\vdots&\vdots&\ddots&\vdots\\[3pt]
\amsparderivc{#1}{#2_{1}}{#2_{#4}}(#3)&
\amsparderivc{#1}{#2_{2}}{#2_{#4}}(#3)&\ldots&
\amsparderivb{#1}{#2_{#4}}(#3)
\end{pmatrix}
}
%
%
...
\def\amsmatb#1{%
\begin{pmatrix}
\matel{#1}{1}{1}& \matel{#1}{1}{2}& \matel{#1}{1}{3}\\
\matel{#1}{2}{1}& \matel{#1}{2}{2}& \matel{#1}{2}{3}\\
\matel{#1}{3}{1}& \matel{#1}{3}{2}& \matel{#1}{3}{3}
\end{pmatrix}
}
%
%
...
\matel{#1}{2}{1}& \matel{#1}{2}{2}&\ldots& \matel{#1}{2}{#3}\\
\vdots&\vdots&\ddots&\vdots\\
\matel{#1}{#2}{1}& \matel{#1}{#2}{2}&\ldots& \matel{#1}{#2}{#3}
\end{pmatrix}
}
%
\def\amsgenmatb#1#2#3{%
\begin{bmatrix}
\matel{#1}{1}{1}& \matel{#1}{1}{2}&\ldots& \matel{#1}{1}{#3}\\
\matel{#1}{2}{1}& \matel{#1}{2}{2}&\ldots& \matel{#1}{2}{#3}\\
\vdots&\vdots&\ddots&\vdots\\
...
%
\def\amsmatsum#1#2#3#4{%
\begin{pmatrix}
\matel{#1}{1}{1} + \matel{#2}{1}{1}& 
\matel{#1}{1}{2} + \matel{#2}{1}{2}&\ldots& 
\matel{#1}{1}{#4} + \matel{#2}{1}{#4}\\
\matel{#1}{2}{1} + \matel{#2}{2}{1}& 
\matel{#1}{2}{2} + \matel{#2}{2}{2}&\ldots& 
\matel{#1}{2}{#4} + \matel{#2}{2}{#4}\\
\vdots&\vdots&\ddots&\vdots\\
\matel{#1}{#3}{1} + \matel{#2}{#3}{1}& 
\matel{#1}{#3}{2} + \matel{#2}{#3}{2}&\ldots& 
\matel{#1}{#3}{#4} + \matel{#2}{#3}{#4}
\end{pmatrix}
}
%
\def\amsmatscal#1#2#3#4{%
\begin{pmatrix}
#4\matel{#1}{1}{1}& #4\matel{#1}{1}{2}&\ldots& #4\matel{#1}{1}{#3}\\
#4\matel{#1}{2}{1}& #4\matel{#1}{2}{2}&\ldots& #4\matel{#1}{2}{#3}\\
\vdots&\vdots&\ddots&\vdots\\
#4\matel{#1}{#2}{1}& #4\matel{#1}{#2}{2}&\ldots& #4\matel{#1}{#2}{#3}
\end{pmatrix}
}
%
\def\amsmatsumb#1#2#3#4{%
\begin{bmatrix}
\matel{#1}{1}{1} + \matel{#2}{1}{1}& 
\matel{#1}{1}{2} + \matel{#2}{1}{2}&\ldots& 
\matel{#1}{1}{#4} + \matel{#2}{1}{#4}\\
...
%
\def\amsgenmatrix#1#2#3{%
\begin{pmatrix}
\matel{#1}{1}{1}& \ldots& \matel{#1}{1}{#3}\\
\vdots&\ddots&\vdots\\
\matel{#1}{#2}{1}& \ldots& \matel{#1}{#2}{#3}
\end{pmatrix}
}
%
%
...
%
\def\amsonecolmatb#1#2#3#4{%
\begin{pmatrix}
#4 & \matel{#1}{1}{2}&\ldots& \matel{#1}{1}{#3}\\
0& \matel{#1}{2}{2}&\ldots& \matel{#1}{2}{#3}\\
\vdots&\vdots&\ddots&\vdots\\
0& \matel{#1}{#2}{2}&\ldots& \matel{#1}{#2}{#3}
\end{pmatrix}
...
\def\amsidmat{%
\begin{pmatrix}
\matel{1}{}{}& \matel{0}{}{}&\ldots& \matel{0}{}{}\\
\matel{0}{}{}& \matel{1}{}{}&\ldots& \matel{0}{}{}\\
\vdots&\vdots&\ddots&\vdots\\
\matel{0}{}{}& \matel{0}{}{}&\ldots& \matel{1}{}{}
\end{pmatrix}
}
%
...
%
%
\def\amsdiagmatrecn#1#2{%
\begin{pmatrix}
#1_{1}&        &\ldots& & 0 &\ldots &0\\
                & #1_{2}  &\ldots& & 0&\ldots& 0 \\
\vdots&\vdots&\ddots&\vdots& 0 &\vdots & 0\\
      &      &\ldots& #1_{#2}& 0 & \ldots & 0
\end{pmatrix}
}
%
...
%
%
\def\amsomegamatrix#1#2{%
\begin{pmatrix}
0        & #1_{1\, 2}&        &              &              \\
-#1_{1\, 2}&     0   &#1_{2\, 3}&              &              \\
         & -#1_{2\, 3}& 0     &\ddots        &              \\
         &          &\ddots &\ddots        &#1_{#2-1\, #2}  \\
         &          &       &-#1_{#2-1\, #2} & 0            
\end{pmatrix}
}
%
...
\def\amsgendet#1#2{%
\begin{vmatrix}
\matel{#1}{1}{1}& \matel{#1}{1}{2}&\ldots& \matel{#1}{1}{#2}\\
\matel{#1}{2}{1}& \matel{#1}{2}{2}&\ldots& \matel{#1}{2}{#2}\\
\vdots&\vdots&\ddots&\vdots\\
\matel{#1}{#2}{1}& \matel{#1}{#2}{2}&\ldots& \matel{#1}{#2}{#2}
\end{vmatrix}
}
...
%
\def\amscharpoly#1#2#3{%
\begin{vmatrix}
#3 - \matel{#1}{1}{1} & -\matel{#1}{1}{2}&\ldots& -\matel{#1}{1}{#2}\\
-\matel{#1}{2}{1}& #3 - \matel{#1}{2}{2} &\ldots& -\matel{#1}{2}{#2}\\
\vdots&\vdots&\ddots&\vdots\\
-\matel{#1}{#2}{1}& -\matel{#1}{#2}{2}&\ldots& #3 - \matel{#1}{#2}{#2}
\end{vmatrix}
}
%
%
...
\def\amsvecdet#1#2#3{%
\begin{vmatrix}
\matel{#1}{1}{1}& \ldots& \matel{#1}{1}{#2 -1}& #3_{1}\\
\matel{#1}{2}{1}& \ldots&\matel{#1}{2}{#2 -1}& #3_{2}\\
\vdots&\vdots&\ddots&\vdots\\
\matel{#1}{#2}{1}&\ldots& \matel{#1}{#2}{#2 -1}& #3_{#2}
\end{vmatrix}
}
...
#7& #8& #9\cr}}
%
\def\amsdetcb#1#2#3#4#5#6#7#8#9{%
\begin{vmatrix}
#1& #2& #3\\
#4& #5& #6\\
#7& #8& #9
...
\def\amsresultant#1#2#3#4{%
\begin{vmatrix}
#1_0 & #1_1 & \cdots & \cdots & #1_{#3} & 0 &\cdots &\cdots &\cdots &\cdots & 0\\
0 &  #1_0 & #1_1 & \cdots & \cdots & #1_{#3} & 0 &\cdots &\cdots &\cdots  & 0\\
\cdots  &\cdots  &\cdots  & \cdots & \cdots &\cdots &\cdots &\cdots &\cdots & \cdots &\cdots\\
\cdots  &\cdots  &\cdots  & \cdots & \cdots &\cdots &\cdots &\cdots &\cdots & \cdots &\cdots\\
\cdots  &\cdots  &\cdots  & \cdots & \cdots &\cdots &\cdots &\cdots &\cdots & \cdots &\cdots\\
\cdots  &\cdots  &\cdots  & \cdots & \cdots &\cdots &\cdots &\cdots &\cdots & \cdots &\cdots\\
0 & \cdots &\cdots  &\cdots &\cdots & 0 & #1_0 & #1_1 & \cdots & \cdots &  #1_{#3}\\
#2_0 & #2_1 & \cdots &  \cdots &\cdots &\cdots &\cdots & #2_{#4} & 0 & \cdots & 0\\
0 &  #2_0 & #2_1 & \cdots &  \cdots & \cdots &\cdots &\cdots & #2_{#4} &  0 &\cdots\\
\cdots  &\cdots  &\cdots & \cdots &\cdots &\cdots &\cdots &\cdots & \cdots & \cdots &\cdots \\
0 & \cdots & 0 & #2_0 & #2_1 &  \cdots & \cdots&\cdots &\cdots &\cdots   & #2_{#4}
\end{vmatrix}
}
...
\def\amsresultantht#1#2#3#4#5{%
\begin{vmatrix}
#1_0 & #5#1_1 & \cdots & \cdots & #5^{#3}#1_{#3} & 0 &\cdots &\cdots &\cdots &\cdots & 0\\
0 &  #1_0 & #5#1_1 & \cdots & \cdots & #5^{#3}#1_{#3} & 0 &\cdots &\cdots &\cdots  & 0\\
\cdots  &\cdots  &\cdots  & \cdots & \cdots &\cdots &\cdots &\cdots &\cdots & \cdots &\cdots\\
\cdots  &\cdots  &\cdots  & \cdots & \cdots &\cdots &\cdots &\cdots &\cdots & \cdots &\cdots\\
\cdots  &\cdots  &\cdots  & \cdots & \cdots &\cdots &\cdots &\cdots &\cdots & \cdots &\cdots\\
\cdots  &\cdots  &\cdots  & \cdots & \cdots &\cdots &\cdots &\cdots &\cdots & \cdots &\cdots\\
0 & \cdots &\cdots  &\cdots &\cdots & 0 & #1_0 & #5#1_1 & \cdots & \cdots &  #5^{#3}#1_{#3}\\
#2_0 & #5#2_1 & \cdots &  \cdots &\cdots &\cdots &\cdots & #5^{#4}#2_{#4} & 0 & \cdots & 0\\
0 &  #2_0 & #5#2_1 & \cdots &  \cdots & \cdots &\cdots &\cdots & #5^{#4}#2_{#4} &  0 &\cdots\\
\cdots  &\cdots  &\cdots & \cdots &\cdots &\cdots &\cdots &\cdots & \cdots & \cdots &\cdots \\
0 & \cdots & 0 & #2_0 & #5#2_1 &  \cdots & \cdots&\cdots &\cdots &\cdots   & #5^{#4}#2_{#4}
\end{vmatrix}%
}
...
\cdots  &\cdots  &\cdots  & \cdots & \cdots &\cdots &\cdots &\cdots &\cdots & \cdots &\cdots\\
0 & \cdots &\cdots  &\cdots &\cdots & 
0 & #5^{#4}#1_0 & #5^{#4+1}#1_1 & \cdots & \cdots &  #5^{#3+#4}#1_{#3}\\
#5#2_0 & #5^{2}#2_1 & \cdots &  \cdots &\cdots &\cdots &\cdots &
 #5^{#4+1}#2_{#4} & 0 & \cdots & 0\\
0 &  #5^{2}#2_0 & #5^{3}#2_1 & \cdots &  \cdots & \cdots &\cdots &\cdots &
 #5^{#4+2}#2_{#4} &  0 &\cdots\\
\cdots  &\cdots  &\cdots & \cdots &\cdots &\cdots &\cdots &\cdots & \cdots & \cdots &\cdots \\
0 & \cdots & 0 & #5^{#3}#2_0 & #5^{#3+1}#2_1 &  
\cdots & \cdots&\cdots &\cdots &\cdots   & #5^{#3+#4}#2_{#4}
\end{vmatrix}%
}
...
\def\amsresultantb#1#2#3#4{%
\begin{vmatrix}
1 & #1_1 & \cdots & \cdots & \cdots & #1_{#3} & 0 &  \cdots &\cdots & 0\\
0 &  1 & #1_1 & \cdots &  \cdots &  \cdots & #1_{#3} & 0 & \cdots&\cdots\\
\cdots  &\cdots  &\cdots &\cdots & \cdots & \cdots &  \cdots & \cdots &\cdots &\cdots \\
0 & \cdots & 0 & 1 & #1_1 & \cdots & \cdots&\cdots&\cdots& #1_{#3}\\
#3 & (#3-1)#2_1 & \cdots & \cdots &#2_{#4} & 0 &  \cdots &  \cdots &  \cdots & 0\\
0 &  #3 & (#3-1)#2_1 & \cdots &\cdots& #2_{#4} & 0 & \cdots &\cdots &  \cdots & \\
\cdots  &\cdots  &\cdots &\cdots & \cdots &\cdots & \cdots &  \cdots & \cdots &\cdots \\
0 & \cdots & \cdots & 0 & #3 & (#3-1)#2_1 &  \cdots &  \cdots & \cdots& #2_{#4}
\end{vmatrix}%
}
...
%
\def\amsvandermonde#1#2{%
\begin{vmatrix}
1& 1&\ldots& 1\\
#1_1& #1_2&\ldots& #1_{#2}\\
#1_{1}^{2}& #1_{2}^{2}&\ldots& #1_{#2}^{2}\\
\vdots&\vdots&\ddots&\vdots\\
#1_{1}^{#2 - 1}& #1_{2}^{#2 - 1}&\ldots& #1_{#2}^{#2 - 1}
\end{vmatrix}
}
%
%
...
%
%
\def\amssvandermonde#1#2{%
\begin{vmatrix}
1& 1&\ldots& 1\\
0& #1_2 - #1_1&\ldots& #1_{#2} - #1_1\\
0& #1_{2}(#1_{2} - #1_1)&\ldots& #1_{#2}(#1_{#2} - #1_1)\\
\vdots&\vdots&\ddots&\vdots\\
0& #1_{2}^{#2 - 2}(#1_{2} - #1_1)&\ldots& #1_{#2}^{#2 - 2}(#1_{#2} - #1_1)
\end{vmatrix}
}
%
...
\def\amsvoldeta#1#2{%
\begin{vmatrix}
\matel{#1}{0}{1}&\matel{#1}{0}{2}&\ldots & \matel{#1}{0}{#2}& 1\\
\matel{#1}{1}{1}&\matel{#1}{1}{2}&\ldots & \matel{#1}{1}{#2}& 1\\
\vdots&\vdots&\ddots&\vdots&\vdots\\
\matel{#1}{#2}{1}&\matel{#1}{#2}{2}&\ldots& \matel{#1}{#2}{#2}& 1
\end{vmatrix}
}
%
\def\voldetb#1#2{%
...
\begin{vmatrix}
\matel{#1}{1}{1} - \matel{#1}{0}{1}&\matel{#1}{1}{2} - \matel{#1}{0}{2}&
\ldots & \matel{#1}{1}{#2} - \matel{#1}{0}{#2}\\
\matel{#1}{2}{1} - \matel{#1}{0}{1}&\matel{#1}{2}{2} - \matel{#1}{0}{2}&
\ldots & \matel{#1}{2}{#2} - \matel{#1}{0}{#2}\\
\vdots&\vdots&\ddots&\vdots\\
\matel{#1}{#2}{1} - \matel{#1}{0}{1}&\matel{#1}{#2}{2} - \matel{#1}{0}{2}&
\ldots&\matel{#1}{#2}{#2} - \matel{#1}{0}{#2}
\end{vmatrix}
...
\def\amsgramdet#1#2{%
\begin{vmatrix}
\norme{#1_1}^2 &\pairt{#1_1}{#1_2}&\ldots & \pairt{#1_1}{#1_{#2}}\\
\pairt{#1_2}{#1_1} &\norme{#1_2}^2&\ldots & \pairt{#1_2}{#1_{#2}}\\
\vdots&\vdots&\ddots&\vdots\\
\pairt{#1_{#2}}{#1_1} &\pairt{#1_{#2}}{#1_2}&\ldots & \norme{#1_{#2}}^2
\end{vmatrix}
}
